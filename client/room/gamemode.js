...
Damage.OnDeath.Add(function (player) {
	...
	// [PC2] принудительный деспавн — убирает тело игрока с карты сразу после
...
function SetEndOfMatch_EndMode() {
	...
	// [PC2] пункт 2: "Команда победила! MVP: ник" вместо стандартной подсказки.
	// Обёрнуто в try/catch — если вдруг что-то пойдёт не так, подсказка
	// не пропадёт совсем, а откатится на стандартный текст.
	try {
		Ui.GetContext().Hint.Value = buildEndOfMatchSummary();
	} catch (e) {
